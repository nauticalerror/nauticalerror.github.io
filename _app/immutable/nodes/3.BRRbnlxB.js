...
people & sites who inspired this project:
    ...
    - <a href=""></a>
    - <a href=""></a>
`};const $=!0,j=()=>({...k}),q=Object.freeze(Object.defineProperty({__proto__:null,load:j,prerender:$},Symbol.toStringTag,{value:"Module"}));var z=p('<div class="content-format flex flex-col gap-8 py-24"><h2 class="text-accent-green heading-2"><!></h2> <p class="body text-white"><!></p></div>'),D=p('<section class="mx-auto h-screen w-full"><!></section>');function A(c,d){g(d,!1);let o=_.data;b();var t=D(),m=e(t);x(m,{children:(f,O)=>{var s=z(),n=e(s),u=e(n);i(u,()=>h(o.hed)),a(n);var r=w(n,2),v=e(r);i(v,()=>h(o.about)),a(r),a(s),l(f,s)},$$slots:{default:!0}}),a(t),l(c,t),y()}export{A as component,q as universal};
